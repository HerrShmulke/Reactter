...
/**
 * @param {import('./PostCard').IPostCardProps} param0
 */
    ...
    <div className={styles.card}>
      ...
      <div className={styles.footer}>
        <div
          ...
          onClick={onLikeClick}
          onKeyPress={(e) => onLikeClick && e.code.toLowerCase() === 'space' && onLikeClick(e)}
          tabIndex='0'
          role='button'
        >
        ...
        <div
          ...
          onKeyPress={(e) => onCommentClick && e.code.toLowerCase() === 'space' && onCommentClick(e)}
          tabIndex='0'
          role='button'
        >
          <svg width='24' height='24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <div
          ...
          onKeyPress={(e) => onShareClick && e.code.toLowerCase() === 'space' && onShareClick(e)}
          tabIndex='0'
          role='button'
        >
          <svg width='24' height='24' fill='none' xmlns='http://www.w3.org/2000/svg'>
